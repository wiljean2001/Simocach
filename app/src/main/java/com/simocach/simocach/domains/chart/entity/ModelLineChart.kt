...
class ModelLineChart(private var mSampleLength: Int = 100, private var mVisibleNum: Int =  -1) {

    private var mTs = 0.1f

    private var mModelChartDataSets: MutableList<ModelChartDataSet> = mutableListOf() //ArrayList(5)
     ...
     */
    private fun getIndex(datatype: Int): Int {
        for (i in mModelChartDataSets.indices) {
